...
std::string PLDFileName ("P14X3M01.HEX");
std::string DriverName ("m14x3m.dll");
std::string DeviceName("ADM214x3M on AMBPCI");

double C = 2.9979e8;		// скорость света в вакууме
...
int main(void){	
    ...
    // ===========================================================================================
    confIonogram conf; // используем имя файла конфигурации по умолчанию
